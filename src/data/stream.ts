export const streamKit = {
  ...
  checklist: [
    ...
    'On the streaming PC, OPEN-OBS.bat (daily). One time: DOUBLE-CLICK-ME.bat → Switch overlays to online so URLs stop using :8765.',
    'If scenes are missing: open overlays/install.html (Chrome) → Connect → Load scenes into OBS (J England Live).',
