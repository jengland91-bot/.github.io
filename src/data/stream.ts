export const streamKit = {
  ...
  checklist: [
    ...
    'Assign Cam / Face (face), Cam / Room (back cam), Cam / Wheel, Cam / Pedals. Copy → Paste (Reference) is already how the installer places them.',
    ...
    'Test: STARTING SOON → GAMING → SIM → SIM RIG → BRB → ENDING on the wide canvas, then the same names in Aitum Vertical.',
