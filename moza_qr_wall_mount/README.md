...
| [`stl/8020_mouse_tray.stl`](stl/8020_mouse_tray.stl) | Right-side **5 × 5 in** mouse tray. Bolt plate at the rear corner; pad sticks toward the wall and toward your hand. Hex cutouts to print faster; rim and gusset stay solid. Stick a cloth pad on the deck. **3 walls / 15% infill.** | Deck on the bed, bolt plate up |
...
The 8020 accessories are lighter. **4 walls / 25% gyroid** is enough for the phone tray, cup, and cable clip. Use **6 walls / 40%** on the headphone hook (it is a cantilever). The mouse tray is already hex-cut: **3 walls / 15% gyroid** is plenty.
