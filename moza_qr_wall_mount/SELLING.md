...
This is a 3D-printed quick-release hanger. Press the wheel onto the stub the same way you mount it on the base — the balls click into a full ring groove, so you do not have to line up slots. Pull the QR collar to take it off.
