...
window.LUMIA_COMMANDS = [
  ...
  { name: "room", message: "Room cam on", cooldownDuration: 15000, description: "OBS: Cam / Room on; Face, Wheel, Pedals off (RACE / GRID / RACE DUAL / DESK)" },
  ...
  { name: "pedals", message: "Pedals cam on", cooldownDuration: 15000, description: "OBS: Cam / Pedals on; Face, Room, Wheel off (RACE / GRID / RACE DUAL)" },
  { name: "game", message: "Game only", cooldownDuration: 15000, description: "OBS: hide Cam / Face, Room, Wheel, Pedals" },
];
